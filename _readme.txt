...
For the work, An Essay on "Darwinism", I examined this eight-leaves manuscript containing only cursive writing, with no other media such as images or tables. I performed text extraction using Transkribus with the pre-trained "B2022 English Model M4." The model achieved roughly 85% accuracy at the word level, with one to two errors per ten words, while character-level accuracy was closer to 97%. However, one major problem I notice is with punctuation—almost 65-70% of it was missed, including commas, periods, colons, and hyphens. Because the model was trained on modern language, it failed to capture historical spellings and hyphenation patterns. Similarly, during manual review, I often encountered older word forms that I had to research to confirm whether they were errors or features of the period. Although the text extraction was mostly reliable in recognizing cursive letters, the frequent punctuation loss and inconsistent recognition of words make this work unreadable without manual correction, which ties back to the labor question. Despite the fact that this work has great archival value, its limited scholarly demands may restrict the resources devoted to further digitization.
